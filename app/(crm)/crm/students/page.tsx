...
export default async function StudentsPage({
  ...
  return (
    <main className="crm-shell min-h-screen">
      <Topbar title="Students" subtitle="Intake, profile management, and application tracking." />
        ...
        <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="crm-panel p-5">
            ...
            <div className="mt-5 space-y-3 text-sm text-text-secondary">
              <p>Capture country preference and test score in the first pass so the profile is immediately usable.</p>
